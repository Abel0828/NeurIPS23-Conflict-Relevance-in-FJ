...
class SuperGAT(torch.nn.Module):
    ...
    def __init__(self, dataloader, args, logger):
        ...
        self.conv1 = SuperGATConv(self.data.x.shape[-1], 16, heads=4)
        self.conv2 = SuperGATConv(64, 16, heads=4)
        self.feedforward = nn.Sequential(torch.nn.Linear(128, 16), nn.ReLU(), nn.Linear(16, 2))
